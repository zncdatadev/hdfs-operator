...
# zncdata.dev/hdfs-operator-bundle:$VERSION and zncdata.dev/hdfs-operator-catalog:$VERSION.
...
HELM_DEPENDS ?= zookeeper-operator commons-operator listener-operator secret-operator
