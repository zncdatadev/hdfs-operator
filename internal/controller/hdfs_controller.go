...
//+kubebuilder:rbac:groups=hdfs.zncdata.dev,resources=hdfs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=hdfs.zncdata.dev,resources=hdfs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=hdfs.zncdata.dev,resources=hdfs/finalizers,verbs=update
